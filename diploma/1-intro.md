...
## TLA+ в индустрии
Изначально TLA+ был разработан Лесли Лампортом в XX веке как инструмент для спецификации собственных алгоритмах и использовался только лишь в академических кругах.
