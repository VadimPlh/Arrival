...
За переходы между состояниями отвечают действия. Они свзяывают старое и новое состояние с помощью переменных. Primed переменных отвечают за новое состояние, а unprimed за старое.
