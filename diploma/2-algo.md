...
Алгоритм корректен, если он удовлетворяет свойствам, которые мы ему предъявили. По теореме https://pron.github.io/posts/tlaplus_part3#safety-and-liveness любое наше св-ва можно выразить через safety и liveness.
