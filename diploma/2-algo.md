...
Есть 2 модели: асинхронная и синхронная. В первой нет ограничений на время
* доставки сообщений
* дрейф часов
* относительную скорость работы узлов.

Вторая модель подразумевает, что в системе есть гарантии на время доставки сообщений и на скорость работы компонент системы.
