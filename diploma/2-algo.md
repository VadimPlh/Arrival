...
В этой модели узлы в нашей системе могут отказывать навсегда или на некоторое время. Мы не рассматриваем Византийские отказы, так как мы проверяем устойчивость и правильность  алгоритма или системы в целом и не рассматриваем внешние вмешательства в алгоритм (кроме сети), так как в реальном мире такое просиходит редко.
