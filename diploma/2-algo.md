...
### Моделирование мира
в нашей системе появляется еще один важный участник - это сама сеть. Сеть может породить проблемы при передаче сообщений между нодами (дубликацию, пропажу и т.д.)
...
При моделировании обмена сообщениями.
