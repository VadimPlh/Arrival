...
Значит при верификации распределенных алгоритмов достаточно проверять только свойства двух приведенных типов: потому что по теореме https://pron.github.io/posts/tlaplus_part3#safety-and-liveness любое наше св-ва можно выразить через safety и liveness.
