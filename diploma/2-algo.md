...
Реальность где-то посередине, так как сеть большую часть времени ведет себя синхроно, но никакая сетевая инфраструктура не может гарантировать это на 100%. Бывают случаи, когда сеть задерживает сообщения или теряет их.
...
В этой модели узлы в нашей системе могут выходить из строя, а потом снова начать работать или отказать навсегда. Мы не рассматриваем Византийские отказы, так как мы проверяем устойчивость и правильность  алгоритма или системы в целом и не рассматриваем внешние вмешательства в алгоритм (кроме сети), так как в реальном мире такое просиходит редко.
