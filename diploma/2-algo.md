...
### Реактивность
У распределенной системы нет точкхи входа и выхода. Она реагирует на действия клиентов на протяжении всей своей работы.
...
В асинхронной сети существует насколько проблем, которые учитываются при проектировании системы:
* Разделение
* Задержка сообщшений
* Потеря сообщений
* Дублирование сообщений

Для моделирования всех этих особенностей используется конструкция \E val \in set: P(val), которая выдает произвольный элемент множества, удовлетворяющий предикату.

Таким образом, у нас нет никакого порядка на элементах множества. С помощью этого моделируются reordering на отправленных сообщениях, задержка соощений и их потеря, так как элемент может никогда не взяться из множества.
