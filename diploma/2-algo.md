...
Реальность где-то посередине. Например: реальная сеть большую часть времени ведет себя синхронно, но никакая сетевая инфраструктура не может гарантировать это на 100% времени. Бывают периоды нестабильности, когда сеть задерживает сообщения или теряет их.

Мы будем использовать асинхронную модель сети, так как она лучше всего описывает настоящий мир. Мы не описываем реальную модель, так как это сложно. Мы сильно пессимизируем, когда описываем систему в асинхронной модели, так как в реальности сеть не бывает бесконечно долгой. Это валидно делать, так как система, работающая в таких суровых ограничениях, будет работать и в реальном мире.
