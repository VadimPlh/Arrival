...
В реальном мире сеть большую часть времени синхронная, но никакая сетевая инфраструктура не может гарантировать это на 100%. Бывают случаи, когда сеть задерживает сообщения или теряет их.
