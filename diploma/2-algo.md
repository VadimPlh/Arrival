...
### Моделирование мира
Займемся моделированием мира, в котором функционирует наша система.

Опишем, как функционирует сеть, с какой скоростью работают узлы.

Ессть 2 модели сети: синхронная модель сети и асинхронная. В первой есть гарантии на время доставки сообщений и на скорость работы компонент системы. Эта модель подразумевает, что в системе:
