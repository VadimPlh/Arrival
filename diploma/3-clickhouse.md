...
Этот алгоритм можно улучшить, чтобы обеспечить sequential consistency для чтений. Чтобы это обеспечить надо во время чтения отвечать, только если на реплике есть все блоки, вставлененые с кворумом. Для этого в ZooKeeper хранится номер последнего записанного блока вместе с кворумом.
