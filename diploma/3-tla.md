...
Когда одна из CONSTANT является множеством, то очень часто спека не зависит от порядка элементов в этом сете, то есть перестановка элементов в этом множестве не нарушит инварианты системы.
