...
Например, в спеке SI юнит тесты проверяют, что оператор FindAllNodesInAnyCycle обнаруживает цикл в графе конфликтующих транзакций.
...
### Покрытия кода
Полезно убедиться, что спека порождает нетривиальные траектории и покрывает написанные экшены. В противном случае
