...
Отдельного внимания заслуживают мерджи. Они должны происходитть на всех репликах одинаково, так как, если порядок был разные, то это может привести к невозможноти скачать кусок данных.

Для этого среди всех реплик назначается лидер, которые произовдит мерджи.

Первой реплике

Для того, что бы лог в Zookeeper не увеличивался до бесконечности был написан алгоритм удаления старых записей
